...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      >
        <div className="w-[350px] max-w-full">
          ...
          >
            <input
              type="email"
              className="h-9 px-4 border border-[#e2e8f0] rounded-lg text-sm text-primary bg-white focus:border-primary focus:outline-none transition-colors w-full placeholder:text-text-lighter"
            ...
            <button
              type="submit"
              className="h-9 bg-primary text-white text-sm font-medium rounded-lg w-full hover:opacity-90 transition-opacity leading-5"
            >
              Sign Up with Email
            </button>
        ...
        <Link
          to="/login"
          className="inline-flex items-center gap-2 px-5 py-2 bg-white text-primary text-sm font-medium border border-[#e2e8f0] rounded-full shadow-sm absolute bottom-20 left-1/2 -translate-x-1/2"
        >
          &larr; Back to Login
        </Link>
      </motion.div>
      ...
      {/* Testimonial Panel */}
      <div className="hidden lg:flex flex-1 bg-app-bg flex-col justify-center p-16 relative">
        <blockquote className="max-w-[580px] text-lg font-normal leading-7 text-primary italic">
          &ldquo;The match score and skill gap analysis gave me clarity I never
          had before. It felt like having a technical recruiter review my resume
          instantly.&rdquo; &mdash; Daniel Pham, DevOps Engineer
        </blockquote>
